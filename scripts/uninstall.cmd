@echo off
:: ============================================
:: Superliminal Head Tracking - Uninstall
:: ============================================
...
set "PRESERVE_FILES=BepInEx\config\CameraUnlock.ini BepInEx\config\com.cameraunlock.superliminal.headtracking.cfg"
